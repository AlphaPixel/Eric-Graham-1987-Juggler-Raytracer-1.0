...
int nearestp(int *c,int *dist)	/* Return the pen nearest to the color c.  Allocate it maybe. */
...
int coldist(int *a,int *b)    /* The 'distance' between two colors after we correct . the worst color */
{int k,r,d,m;
