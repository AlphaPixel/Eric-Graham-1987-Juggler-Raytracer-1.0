...
void ham(int i,int j,double *brite);
void setup(struct observer *o,struct world *w,int *skip);

void setup(struct observer *o,struct world *w,int *skip)         /*      This function is really a stub, you should .change it to suit your needs  */
{
